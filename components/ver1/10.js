  ...
  const material = useMemo(() => new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main(){
        ...
        float envelope = smoothstep(0.0, 0.85, r);
        float outwardWave = radial * envelope * 0.55;
        ...
        float f1=topness*1.8+phase+totalRipple+totalElastic + outwardWave*0.5;
        float f2=topness*1.8+phase+blurAmount+totalRipple*0.8+totalElastic*0.6 + outwardWave*0.35; 
        float f3=topness*1.8+phase+(blurAmount*1.5)+totalRipple*0.6+totalElastic*0.4 + outwardWave*0.22;
