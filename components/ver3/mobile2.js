  ...
  const material = useMemo(() => new THREE.ShaderMaterial({
    ...
    fragmentShader: `
      ...
      void main(){
        ...
        float f1=topness*1.8+phase+totalRipple+totalElastic+totalWaterRipple*0.5; 
        float f2=topness*1.8+phase+blurAmount+totalRipple*0.8+totalElastic*0.6+totalWaterElastic*0.4; 
        float f3=topness*1.8+phase+(blurAmount*1.5)+totalRipple*0.6+totalElastic*0.4+totalWaterRipple*0.3;
        ...
        lit+=rippleColor+elasticColor+waterColor;
